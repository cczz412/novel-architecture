...
- 当前版本、路径和候选身份：[`governance/current_pointers.json`](governance/current_pointers.json)
- 本文件原来的 2026-07-20 进度全文：[`history/root_current_snapshot_20260720.md`](history/root_current_snapshot_20260720.md)

任务状态冲突时，以 Linear 当前关系和 GitHub 当前 Issue／PR／main 现场回读为准；版本、路径或候选身份冲突时，再用 `governance/current_pointers.json` 与带日期的 `governance/CURRENT_STATE.json` 停下校准。产品拍板仍以 CZ 最新明确指令为准；四台分工见 [`governance/COLLAB_GITHUB_LINEAR_SLACK.md`](governance/COLLAB_GITHUB_LINEAR_SLACK.md)。
