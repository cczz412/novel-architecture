...
作者在大纲里选了一条计划（或选项消化了）。系统能不能立刻把伏笔标成已兑现、人物状态改成已经那样？

## 对的做法（已拍）

「消化」与「实际发生」是两层。选项消化清单只管「安排进了章计划」；「实际发生」只能由六态对账边或作者签字推进。六态对账边不是第三条进真值的权力：它只是拿已经有权的材料（书稿证据或作者签字）去判定计划有没有变成已发生，自己不能发明事实。作者选中计划写成「已兑现」是走样；选定即消化这个机制本身不动。

## 加固形状（SI-008，还不是合同）

完成要拆开：Agent 这轮说完 ≠ 工件好了 ≠ 作者确认了 ≠ 章关了。关章只认作者关章事件：系统过硬门槛后只能建议关章，作者确认才算关章事件。
...
选项一确认就让计划、伏笔、人物、灵感一起变成「已落地」，事实账里却还没有 F。用工作流 `completed`／裸 `done` 直接关章。把「每个 JSON 文件 rename 成功」当成跨账一起成功。
