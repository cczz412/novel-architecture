...
COMPACT_R01_DIR = ROOT / (
    "finetuning/experiments/"
    "T5_R04_TRAIN72_COMPACT_TARGET24_MODEL_NEUTRAL_GOLD_20260809_R01"
)
COMPACT_R01_SOURCE = COMPACT_R01_DIR / "SOURCE_INDEX_24.jsonl"
COMPACT_R01_GOLD = COMPACT_R01_DIR / "MODEL_NEUTRAL_GOLD_24.jsonl"
...
EXPECTED_COMPACT_R01_SOURCE_SHA = (
    "689da403b6b6d0df13471f927f162c79d622dd335dd12802372d6925a390f1e4"
)
EXPECTED_COMPACT_R01_GOLD_SHA = (
    "8f84358f01da0822e7337fa4a30ce5cc7d0e8529724ea6214a6fce00ed6bb137"
)
...
SPECS = [
    ...
    ("CT72-M10", "MEDIUM_4_TO_6", "SUP16-F-02", 11, 14, 6),
...
def check_parent_bindings() -> None:
    ...
    if file_sha256(COMPACT_R01_SOURCE) != EXPECTED_COMPACT_R01_SOURCE_SHA:
        raise ValueError("紧凑负责区 R01 来源索引 SHA 漂移")
    if file_sha256(COMPACT_R01_GOLD) != EXPECTED_COMPACT_R01_GOLD_SHA:
        raise ValueError("紧凑负责区 R01 Gold SHA 漂移")
...
def validate_gold(
    ...
    if fact_total != 68:
        raise ValueError(f"R02 事实总数不是68：{fact_total}")
    return {
        "cases": len(gold_rows),
        "facts": fact_total,
