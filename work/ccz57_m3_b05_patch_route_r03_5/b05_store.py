...
def _find_lineage(value: Any) -> str | None:
        ...
        for operation in group["operations"]:
            ...
            if kind == "REPLACE_CANDIDATE_ITEM":
                ...
                if len(matches) != 1:
                    ...
                    continue
                index = matches[0]
                actual_hash = items[index].get("item_hash") or _item_hash(items[index])
                ...
                if not isinstance(replacement, dict):
                    ...
                    continue
                replacement["item_hash"] = _item_hash(replacement)
                ...
                if not isinstance(addition, dict):
                    errors.append("CANDIDATE_STRUCTURE_INVALID")
                    continue
                addition["item_hash"] = _item_hash(addition)
