...
- **谁做**：候选落库＋脚本云端可做；owner 复核与六例设计偏语义，建议本地 Codex 主做。
...
- **谁做**：涉及本地外置盘的（foundation、finetuning、survey 原件）由本地 Codex 做；纯 Git 内退路由云端可做。
...
| 只能你（CZ） | 本地 Codex | 云端 Agent |
|---|---|---|
| 5 件产品拍板（见决策书） | owner 复核、六例设计 | 工单 1、2、4、7 全部 |
| 逐 PR 复核合并 | 外置盘归档（工单 6 大件） | 工单 3 候选落库、工单 5 逐票拆分 |
| 否决任何归档条目 | Notion 回读同步 | 防漂移脚本与测试 |
