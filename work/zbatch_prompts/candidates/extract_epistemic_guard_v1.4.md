...
- 证据原文用“也许”“据说”或“猜测”表达某一命题时，该命题不得标 `assertion`＝“明”；只能标“推”或“存疑”，且不能把“有人说过这句话”偷换成“话中内容已经明示为真”。
- A 一条只放一个可消费变化，不复述场景。
...
来源：Codex（依 Notion v0.3、Z 执行单、Z00d 漏抽证据与 Luna 扫描整理）
