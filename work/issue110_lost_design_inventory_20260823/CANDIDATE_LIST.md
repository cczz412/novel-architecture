...
盘点：2026-08-23 仓内／旁仓／git 搜证 + 补读 NVM。Notion 还没搜。来源怎么读见 [00_READ_ME.md](00_READ_ME.md)。这两页进 Git 的路径是 `work/issue110_lost_design_inventory_20260823/`。
