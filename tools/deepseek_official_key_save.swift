...
private let service = "cn.cz.novel-architecture.deepseek.official.v4-pro"
...
alert.messageText = "配置 DeepSeek 官方 V4 Pro"
alert.informativeText = "请输入 DeepSeek 官方 API Key。钥匙只保存到本机 macOS 钥匙串，不会写入项目文件或 Git。"
alert.addButton(withTitle: "保存")
alert.addButton(withTitle: "取消")

let input = NSSecureTextField(frame: NSRect(x: 0, y: 0, width: 420, height: 24))
input.placeholderString = "DeepSeek API Key"
