# ST-001｜语料重标（Deep Research 分窗）

状态：`整理已落·w01梗概待补`｜`欠回传·非消账·非已拍·非开工`  
主线隔离：✅ 不碰 current／decisions／reports／zbatch

## 一句话目标

全书库浅表：读者可读梗概＋分类标签（产品表1）；约 50本／窗。≠拆结构真账。

## 进度

| 项 | 内容 |
|---|---|
| 已完成 | w01～**w07 已入站**；`product_shallow` **350**（含 w01 占位）；认亲 r01；**按用途整理包已落** |
| 进行中 | — |
| 下一步 | 认亲仍开 2 本给人看；w01 真梗概按需另补 |
| 阻塞 | 无 |
...
| 用途 | 点这里 |
|---|---|
| **按用途逛三表** | [dr_three_tables_tidy_20260719/](../../../TEMP/dr_three_tables_tidy_20260719/) |
