...
| 新需求 | 作者需求候选先查 [Notion 候选主存](https://app.notion.com/p/3d95cadc4d0f814ea64ae42cb1786771)；具体活动任务与未决问题，从 [Linear 总入口](https://linear.app/ccz/document/4ddff334d4f0)找所属 Project | 候选保留来源、判断和去向，不自动成为产品要求。CCZ-128 已停用，只供追查历史，不再收件；需要进仓的交付再配 GitHub 施工票。工程真源仍是 GitHub。 |
